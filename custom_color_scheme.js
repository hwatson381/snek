if(window.snake) {
  window.snake.scheme = function(settings = {}) {
      ...
      setTimeout(_ => {
        ...
        function processCode(code) {
          ...
          setTimeout(function() {
            ...
            if(settings.burger || settings.cactus || settings.hotdog || settings.egg || settings.lime || settings.red_pepper || settings.cane || settings.cracker || settings.tree) {
              const normal = {
    ...
    window.snake_scheme_epic_gcool = JSON.stringify(settings);
  };
