        ...
        function processCode(code) {
          ...
          setTimeout(function() {
            ...
            if(settings.grey_skull || settings.burger || settings.cactus || settings.hotdog || settings.egg || settings.lime || settings.red_pepper || settings.cane || settings.cracker || settings.tree || settings.custom_url) {
              const normal = {
                grey_skull: i('https://www.google.com/logos/fnbx/snake_arcade/v4/apple_00.png'),
                ...
                custom:     i(settings.custom_url),
              };
              

              const dead = {
                grey_skull: i('https://www.google.com/logos/fnbx/snake_arcade/v12/trophy_10.png'),
                ...
                custom:  document.createElement('canvas'),
              };

              dead.custom.width = dead.custom.height = 128;
              const ____ctx = dead.custom.getContext('2d');
              const ____ = new Image();
              ...
              setTimeout(_ => {
                ...
                settings.grey_skull && (window.darks.push(dead.grey_skull), document.querySelector('#apple').appendChild(normal.grey_skull));
